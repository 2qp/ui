import { Callout } from "@/components/registry/callout";
import { CodeBlockCommand } from "@/components/registry/code-block-command";
...
// const MDXRemote = (props: React.ComponentProps<typeof MDXR>) => (
//   <MDXR {...props} components={COMPONENTS} />
// );
// for frontmatter separation
// but loosing pre shikied / transformed data
// using exported js obj from mdx as metadata is easier
//
// next-mdx-remote-client , gray-matter
